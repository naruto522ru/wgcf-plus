...
if [ $(command -v zip) ]; then
    ...
    #Linux 32bit
    zip -9 ./Linux-32bit-WSL.zip  pywarp.py invisibles-crack warp_config_generator.sh wgcf
    #WSL Windows only 64bit
    #zip -9 ./WSL.zip  pywarp.py invisibles-crack warp_config_generator.sh wgcf
    #Linux ARMv7
